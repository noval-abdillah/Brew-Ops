    ...
    <div className="min-h-screen bg-gradient-to-br from-stone-50 via-amber-50/30 to-stone-100 text-stone-900 font-sans flex flex-col justify-between">
      ...
      <nav className="bg-white/95 backdrop-blur-xl shadow-sm border-b border-stone-200 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <Link href="/pricing" className="text-sm font-bold text-amber-600">Pricing</Link>
          </div>
      ...
      <main className="max-w-7xl mx-auto px-6 py-20 flex-1">
        <div className="text-center mb-16">
          <span className="text-xs font-bold text-amber-600 uppercase tracking-wider bg-white px-4 py-2 rounded-full shadow-md">Simple Pricing</span>
          <h2 className="text-4xl md:text-5xl font-black mt-6">Start Free, Scale as You Grow</h2>
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {plans.map((plan, idx) => (
            <div 
              key={idx}
              className={`relative p-8 bg-white border-2 rounded-3xl transition-all duration-500 hover:-translate-y-2 cursor-pointer ${
                plan.popular 
            ...
            >
              ...
              <Link
                ...
                className={`block w-full py-4 rounded-xl font-bold text-center transition-all hover:scale-105 active:scale-95 ${
                  plan.popular
                    ? 'coffee-gradient text-white shadow-lg'
