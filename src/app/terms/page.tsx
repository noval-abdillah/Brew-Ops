  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-stone-50 via-amber-50/30 to-stone-100 text-stone-900 font-sans flex flex-col justify-between">
      ...
      <main className="max-w-4xl mx-auto px-6 py-20 flex-1">
        <span className="text-xs font-bold text-amber-600 uppercase tracking-wider bg-amber-100 px-3 py-1.5 rounded-full">Terms of Service</span>
        <h2 className="text-4xl font-black mt-4">Terms of Service</h2>
        <p className="text-stone-600 mt-6 leading-relaxed">
          By deploying your coffee shop tenant on BrewOps, you agree to comply with our fair-use data scraping policies, secure storage guidelines for API credentials, and employee privacy standards.
        </p>
      </main>
