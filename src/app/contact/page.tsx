  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-stone-50 via-amber-50/30 to-stone-100 text-stone-900 font-sans flex flex-col justify-between">
      ...
      <main className="max-w-5xl mx-auto px-6 py-20 flex-1">
        <span className="text-xs font-bold text-amber-600 uppercase tracking-wider bg-amber-100 px-3 py-1.5 rounded-full">Contact</span>
        
        <div className="grid lg:grid-cols-2 gap-12 mt-6 items-center">
          <div className="space-y-6">
            <h2 className="text-4xl font-black mt-4">Get in Touch</h2>
            <p className="text-stone-600 leading-relaxed">
              Need help setting up your coffee shop terminal or custom print templates? Our support engineers are ready to assist you.
            </p>
            <div className="space-y-4 pt-2">
              <div className="flex items-center gap-3 text-stone-700">
                <Mail className="w-5 h-5 text-amber-600" />
                <a href="mailto:support@brewops.com" className="text-sm hover:underline">support@brewops.com</a>
              </div>
              <div className="flex items-center gap-3 text-stone-700">
              ...
              <div className="flex items-center gap-3 text-stone-700">
                ...
                <span className="text-sm">100 Specialty Coffee Lane, Seattle, WA</span>
              </div>
            </div>
          </div>
