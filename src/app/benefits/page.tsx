...
import { Coffee, Clock, TrendingUp, Shield, CheckCircle2, ArrowRight } from 'lucide-react';
      ...
      <nav className="bg-white/95 backdrop-blur-xl shadow-sm border-b border-stone-200 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <Link href="/benefits" className="text-sm font-bold text-amber-600">Benefits</Link>
      ...
      <main className="max-w-7xl mx-auto px-6 py-20 flex-1">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-8">
            <span className="text-xs font-bold text-amber-600 uppercase tracking-wider bg-amber-100 px-3 py-1.5 rounded-full">Benefits</span>
            <h2 className="text-4xl md:text-5xl font-black mt-4">Why Coffee Shops Choose BrewOps</h2>
          ...
          <div className="relative">
            <div className="aspect-square rounded-3xl bg-gradient-to-br from-amber-100 to-amber-200 p-8 shadow-2xl">
              <div className="w-full h-full rounded-2xl bg-white/90 backdrop-blur border border-stone-200 p-8 flex flex-col justify-center items-center text-center relative overflow-hidden">
                <Coffee className="w-20 h-20 text-amber-600 mb-6 animate-bounce relative z-10" />
                ...
                <Link href="/register" className="px-8 py-4 coffee-gradient rounded-xl font-bold text-white shadow-lg hover:shadow-2xl transition-all hover:scale-105 active:scale-95 relative z-10">
                  Get Started Now
                </Link>
              </div>
            </div>
