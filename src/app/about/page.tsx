...
import { Coffee, Shield, Globe, Award, Sparkles } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-stone-50 via-amber-50/30 to-stone-100 text-stone-900 font-sans flex flex-col justify-between">
      ...
      <main className="max-w-5xl mx-auto px-6 py-20 flex-1">
        <span className="text-xs font-bold text-amber-600 uppercase tracking-wider bg-amber-100 px-3 py-1.5 rounded-full">About Us</span>
        
        <div className="grid lg:grid-cols-2 gap-12 mt-6 items-center">
          <div className="space-y-6">
            <h2 className="text-4xl font-black leading-tight">We Love Coffee Shop Operations</h2>
            <p className="text-stone-600 leading-relaxed">
              BrewOps is dedicated to simplifying point-of-sale, stock tracking, and staff management for modern cafes and specialty roasters worldwide. Our mission is to save hours of daily logistics so owners can focus on roasting and serving amazing coffee.
            </p>
            <p className="text-stone-600 leading-relaxed">
              Founded in 2026, we serve hundreds of independent coffee brewers, cafes, and multi-outlet roasters to automate ordering queues, staff shift allocation, and predictive inventory forecasts.
            </p>
            <div className="flex gap-4 items-center pt-2">
              <div className="flex -space-x-2">
                <span className="w-10 h-10 rounded-full bg-amber-600 flex items-center justify-center text-white font-bold border-2 border-white">B</span>
                <span className="w-10 h-10 rounded-full bg-amber-500 flex items-center justify-center text-white font-bold border-2 border-white">O</span>
              </div>
              <div className="text-xs text-stone-500 font-semibold">
                Trusted by 500+ Cafe Owners worldwide.
              </div>
            </div>
          </div>
          <div className="relative">
            <img 
              ...
              alt="Specialty Roaster Operations" 
